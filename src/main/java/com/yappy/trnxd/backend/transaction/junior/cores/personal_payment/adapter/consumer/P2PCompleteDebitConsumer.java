...
@Slf4j
@Component("P2PCompleteDebitConsumer")
public class P2PCompleteDebitConsumer extends ConsumerTemplate<BeginTransactionDTO> {
    ...
    protected void setDefaultValues(BeginTransactionDTO message) {
        message.setOperation(OperationTypeEnum.DEBIT.name());
    }
}